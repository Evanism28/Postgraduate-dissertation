...
par(tcl = -0.25)
par(mgp = c(2, 0.6, 0))
plot(col = 'red',rational_dg$year,rational_dg$rapolano_elevated_pred *500 ,  xaxt = 'n',type ='o', lty = 1, ylim = c(0.4, 2.5) )
lines(col ='red',rational_dg$year,rational_dg$rapolano_elevated * 500, xaxt = 'n',type ='o',lty =2, pch = '*', cex = 1.8)
lines(col ='blue',rational_dg$year,rational_dg$rapolano_control_pred * 500, xaxt = 'n',type ='o', lty =1)
lines(col ='blue',rational_dg$year,rational_dg$rapolano_control * 500, xaxt = 'n',type ='o',lty =2, pch = '*', cex = 1.8)
...
# legend('topright', c('elevated(simulation)', 'elevated', 'control(simulation)', 'control'), lty = c(1,2,1,2), col = c('red', 'red','blue', 'blue'), pch = c('o', '*', "o", "*"))

legend('topright', c('elevated(simulation)', 'elevated'), lty = c(1,2), col = c('red', 'red'), pch = c("o", "*"))
legend('topleft', c('control(simulation)', 'control'), lty = c(1,2), col = c('blue', 'blue'), pch = c("o", "*"))

mtext('Rapolano', side = 1, line = -1.5, adj = 0.5, cex = 0.8)


plot(col = 'red',rational_dg$year,rational_dg$laiatico_elevated_pred *500 ,  xaxt = 'n',type ='o', lty = 1, ylim = c(0.4, 2.5) )
lines(col ='red',rational_dg$year,rational_dg$laiatico_elevated * 500, xaxt = 'n',type ='o',lty =2, pch = '*', cex = 1.8)
lines(col ='blue',rational_dg$year,rational_dg$laiatico_control_pred * 500, xaxt = 'n',type ='o', lty =1)
lines(col ='blue',rational_dg$year,rational_dg$laiatico_control * 500, xaxt = 'n',type ='o',lty =2, pch = '*', cex = 1.8)
legend('topright', c('elevated(simulation)', 'elevated'), lty = c(1,2), col = c('red', 'red'), pch = c("o", "*"))
legend('topleft', c('control(simulation)', 'control'), lty = c(1,2), col = c('blue', 'blue'), pch = c("o", "*"))

mtext('Laiatico', side = 1, line = -1.5, adj = 0.5, cex = 0.8)
...
### FOTO3
opt_df = rational_dg
colnames(rational_dg)
opt_df = opt_df[,c("year"    ,  
  "rapolano_control"  ,     "rapolano_elevated"  ,    "laiatico_control"  ,
  "laiatico_elevated" ,                  "rapolano_control_pred" ,
  "rapolano_control_diam",  "rapolano_elevated_pred" ,"rapolano_elevated_diam",
  "laiatico_control_pred" , "laiatico_control_diam"  ,"laiatico_elevated_pred",
  "laiatico_elevated_diam"
  
)]
colnames(opt_df)[c(2,3,4,5,6,8,10,12)]
opt_df[,2:ncol(opt_df)] = opt_df[2:ncol(opt_df)] * 1000
opt_df[,c(2,3,4,5,6,8,10,12) ] = opt_df[,c(2,3,4,5,6,8,10,12) ] /2
